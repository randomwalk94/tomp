%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Function to find optimal thresholding parameter under No Phantom Signal test
% 
...
function optimal_tau = thresh(A,lowertau,uppertau)
...
testn = 100;     % the number of experiments for each tau
